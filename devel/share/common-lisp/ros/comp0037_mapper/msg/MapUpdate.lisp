...
(cl:in-package comp0037_mapper-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <MapUpdate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapUpdate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comp0037_mapper-msg:<MapUpdate> is deprecated: use comp0037_mapper-msg:MapUpdate instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MapUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_mapper-msg:header-val is deprecated.  Use comp0037_mapper-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'isPriorMap-val :lambda-list '(m))
(cl:defmethod isPriorMap-val ((m <MapUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_mapper-msg:isPriorMap-val is deprecated.  Use comp0037_mapper-msg:isPriorMap instead.")
  (isPriorMap m))

(cl:ensure-generic-function 'scale-val :lambda-list '(m))
(cl:defmethod scale-val ((m <MapUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_mapper-msg:scale-val is deprecated.  Use comp0037_mapper-msg:scale instead.")
  (scale m))

(cl:ensure-generic-function 'extentInCells-val :lambda-list '(m))
(cl:defmethod extentInCells-val ((m <MapUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_mapper-msg:extentInCells-val is deprecated.  Use comp0037_mapper-msg:extentInCells instead.")
  (extentInCells m))

(cl:ensure-generic-function 'resolution-val :lambda-list '(m))
(cl:defmethod resolution-val ((m <MapUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_mapper-msg:resolution-val is deprecated.  Use comp0037_mapper-msg:resolution instead.")
  (resolution m))

(cl:ensure-generic-function 'occupancyGrid-val :lambda-list '(m))
(cl:defmethod occupancyGrid-val ((m <MapUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_mapper-msg:occupancyGrid-val is deprecated.  Use comp0037_mapper-msg:occupancyGrid instead.")
  (occupancyGrid m))

(cl:ensure-generic-function 'deltaOccupancyGrid-val :lambda-list '(m))
(cl:defmethod deltaOccupancyGrid-val ((m <MapUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_mapper-msg:deltaOccupancyGrid-val is deprecated.  Use comp0037_mapper-msg:deltaOccupancyGrid instead.")
