...
(cl:defmethod cl:initialize-instance :after ((m <RequestMapUpdate-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RequestMapUpdate-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comp0037_mapper-srv:<RequestMapUpdate-request> is deprecated: use comp0037_mapper-srv:RequestMapUpdate-request instead.")))
...
(cl:defmethod deltaOccupancyGridRequired-val ((m <RequestMapUpdate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_mapper-srv:deltaOccupancyGridRequired-val is deprecated.  Use comp0037_mapper-srv:deltaOccupancyGridRequired instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RequestMapUpdate-request>)))
  ...
  "comp0037_mapper/RequestMapUpdateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestMapUpdate-request)))
  "Returns string type for a service object of type 'RequestMapUpdate-request"
  "comp0037_mapper/RequestMapUpdateRequest")
...
(cl:defclass <RequestMapUpdate-response> (roslisp-msg-protocol:ros-message)
  ((initialMapUpdate
    ...
    :type comp0037_mapper-msg:MapUpdate
    :initform (cl:make-instance 'comp0037_mapper-msg:MapUpdate)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <RequestMapUpdate-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RequestMapUpdate-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comp0037_mapper-srv:<RequestMapUpdate-response> is deprecated: use comp0037_mapper-srv:RequestMapUpdate-response instead.")))
...
(cl:defmethod initialMapUpdate-val ((m <RequestMapUpdate-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_mapper-srv:initialMapUpdate-val is deprecated.  Use comp0037_mapper-srv:initialMapUpdate instead.")
  (initialMapUpdate m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RequestMapUpdate-response>)))
  ...
  "comp0037_mapper/RequestMapUpdateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestMapUpdate-response)))
  "Returns string type for a service object of type 'RequestMapUpdate-response"
  "comp0037_mapper/RequestMapUpdateResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestMapUpdate)))
  ...
  "comp0037_mapper/RequestMapUpdate")