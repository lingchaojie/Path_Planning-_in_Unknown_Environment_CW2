...
(cl:in-package comp0037_reactive_planner_controller-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Goal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Goal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comp0037_reactive_planner_controller-srv:<Goal-request> is deprecated: use comp0037_reactive_planner_controller-srv:Goal-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Goal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_reactive_planner_controller-srv:x-val is deprecated.  Use comp0037_reactive_planner_controller-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Goal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_reactive_planner_controller-srv:y-val is deprecated.  Use comp0037_reactive_planner_controller-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Goal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_reactive_planner_controller-srv:theta-val is deprecated.  Use comp0037_reactive_planner_controller-srv:theta instead.")
  (theta m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Goal-request>)))
  ...
  "comp0037_reactive_planner_controller/GoalRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Goal-request)))
  "Returns string type for a service object of type 'Goal-request"
  "comp0037_reactive_planner_controller/GoalRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Goal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Goal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comp0037_reactive_planner_controller-srv:<Goal-response> is deprecated: use comp0037_reactive_planner_controller-srv:Goal-response instead.")))

(cl:ensure-generic-function 'reachedGoal-val :lambda-list '(m))
(cl:defmethod reachedGoal-val ((m <Goal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp0037_reactive_planner_controller-srv:reachedGoal-val is deprecated.  Use comp0037_reactive_planner_controller-srv:reachedGoal instead.")
  (reachedGoal m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Goal-response>)))
  ...
  "comp0037_reactive_planner_controller/GoalResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Goal-response)))
  "Returns string type for a service object of type 'Goal-response"
  "comp0037_reactive_planner_controller/GoalResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Goal)))
  ...
  "comp0037_reactive_planner_controller/Goal")